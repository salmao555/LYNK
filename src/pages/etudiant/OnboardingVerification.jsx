...
const inputClass =
  'w-full bg-cream rounded-xl px-4 py-3 text-sm outline-none border border-cream-border focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary transition-all'
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <button
                type="button"
                onClick={addSkill}
                className="shrink-0 px-4 rounded-xl border border-cream-border hover:bg-cream text-slate-600"
              >
          ...
          <div>
            ...
            <div className="space-y-4">
              {profile.experience.map((exp, i) => (
                <div key={i} className="rounded-xl border border-cream-border p-4 space-y-3">
                  <input
                    value={exp.titre}
