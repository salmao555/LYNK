function FilterSidebar() {
  ...
  return (
    <aside className="w-64 shrink-0">
      ...
      <div className="mb-8">
        <p className="text-xs font-semibold text-slate-400 tracking-wide mb-3">SECTEUR</p>
      ...
      <div className="mb-8">
        <p className="text-xs font-semibold text-slate-400 tracking-wide mb-3">DURÉE</p>
        <div className="flex flex-col gap-1">
          {durees.map((d, i) => (
            <button
              key={d}
      ...
      <div>
        <p className="text-xs font-semibold text-slate-400 tracking-wide mb-3">MODE</p>
        <div className="flex flex-col gap-1">
          {modes.map((m, i) => (
            <button
              key={m}
